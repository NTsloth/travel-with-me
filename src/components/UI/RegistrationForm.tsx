...
export function RegistrationForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isLogin) {
      ...
      if (age < 18) {
        setError("რეგისტრაციისთვის საჭიროა იყოთ 18 წლის ან მეტის");
        return;
      }
    }
    ...
    const dataToSubmit = {
      ...formData,
      driverAge: !isLogin ? calculateAge(formData.birthDay, formData.birthMonth, formData.birthYear) : undefined
    };
